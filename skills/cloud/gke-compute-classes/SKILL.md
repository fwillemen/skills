...
> [!NOTE]
> **Automatic Driver Management**: In GKE Autopilot, NVIDIA GPU drivers are automatically installed and managed by GKE. Workloads do not require manual driver installation or DaemonSets.
